...
import { update, fetch } from '../../stores/human_resources/human_resourcesSlice'
import { useAppDispatch, useAppSelector } from '../../stores/hooks'
import { useRouter } from 'next/router'
import dataFormatter from '../../helpers/dataFormatter';

const EditHuman_resourcesPage = () => {
  ...
  useEffect(() => {
      if (typeof human_resources === 'object') {
          ...
          Object.keys(initVals).forEach(el => newInitialVal[el] = (human_resources)[el])
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={'Edit human_resources'} main>
        {''}
...
EditHuman_resourcesPage.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default EditHuman_resourcesPage
