...
const EditInventory = () => {
  ...
  useEffect(() => {
      if (typeof inventory === 'object') {
          ...
          Object.keys(initVals).forEach(el => newInitialVal[el] = (inventory)[el])
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={'Edit inventory'} main>
        {''}
    ...
    >
        ...
        />
              ...
              <BaseButtons>
                ...
                <BaseButton type='reset' color='danger' outline label='Cancel' onClick={() => router.push('/inventory/inventory-list')}/>
              </BaseButtons>
            </Form>
          </Formik>
        </CardBox>
