...
const Quality_controlView = () => {
    ...
    return (
      <>
          ...
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={removeLastCharacter('View quality_control')} main>
                <BaseButton
                  color='info'
                  label='Edit'
            ...
            <CardBox>
                ...
                <FormField label='Compliance'>
                    <SwitchField
                      field={{name: 'compliance', value: quality_control?.compliance}}
