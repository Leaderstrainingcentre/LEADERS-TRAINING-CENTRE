...
import { update, fetch } from '../../stores/quality_control/quality_controlSlice'
...
const EditQuality_control = () => {
  ...
  useEffect(() => {
      if (typeof quality_control === 'object') {
          ...
          Object.keys(initVals).forEach(el => newInitialVal[el] = (quality_control)[el])
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={'Edit quality_control'} main>
        {''}
