...
const EditRaw_materials = () => {
  ...
  useEffect(() => {
      if (typeof raw_materials === 'object') {
          ...
          Object.keys(initVals).forEach(el => newInitialVal[el] = (raw_materials)[el])
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={'Edit raw_materials'} main>
        {''}
    ...
    >
        ...
        />
              ...
              <BaseButtons>
                ...
                <BaseButton type='reset' color='danger' outline label='Cancel' onClick={() => router.push('/raw_materials/raw_materials-list')}/>
              </BaseButtons>
            </Form>
          </Formik>
        </CardBox>
