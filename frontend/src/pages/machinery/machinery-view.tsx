...
const MachineryView = () => {
    ...
    return (
      <>
          ...
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={removeLastCharacter('View machinery')} main>
                <BaseButton
                  color='info'
                  label='Edit'
            ...
            <CardBox>
                ...
                <FormField label='MaintenanceSchedule'>
                    {machinery.maintenance_schedule ? <DatePicker
                      dateFormat="yyyy-MM-dd hh:mm"
                      showTimeSelect
                      selected={machinery.maintenance_schedule ?
                        new Date(
                          dayjs(machinery.maintenance_schedule).format('YYYY-MM-DD hh:mm'),
                        ) : null
                      }
                      disabled
