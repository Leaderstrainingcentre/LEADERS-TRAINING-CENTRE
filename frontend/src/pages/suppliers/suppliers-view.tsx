...
const SuppliersView = () => {
    ...
    return (
      <>
          ...
          <SectionMain>
            <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title={removeLastCharacter('View suppliers')} main>
                <BaseButton
                  color='info'
                  label='Edit'
            ...
            <CardBox>
                ...
                <FormField label='Multi Text' hasTextareaHeight>
                  <textarea className={'w-full'} disabled value={suppliers?.contract_terms} />
                </FormField>

                <FormField label='DeliverySchedule'>
                    {suppliers.delivery_schedule ? <DatePicker
                      dateFormat="yyyy-MM-dd hh:mm"
                      showTimeSelect
                      selected={suppliers.delivery_schedule ?
                        new Date(
                          dayjs(suppliers.delivery_schedule).format('YYYY-MM-DD hh:mm'),
                        ) : null
                      }
                      disabled
