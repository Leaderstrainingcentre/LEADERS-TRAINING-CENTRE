...
const ListMachinery = ({ machinery, loading, onDelete, currentPage, numPages, onPageChange }: Props) => {
                    ...
                    <CardBox hasTable isList className={'rounded shadow-none'}>
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>DowntimeHours</p>
                                <p className={'line-clamp-2'}>{ item.downtime_hours }</p>
                            </div>
