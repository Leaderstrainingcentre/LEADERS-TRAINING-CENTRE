...
const ListWork_orders = ({ work_orders, loading, onDelete, currentPage, numPages, onPageChange }: Props) => {
                        ...
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                ...
                                <p className={'line-clamp-2'}>{ item.materials }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>Labor</p>
                                <p className={'line-clamp-2'}>{ item.labor }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>Machinery</p>
                                <p className={'line-clamp-2'}>{ item.machinery }</p>
                            </div>
