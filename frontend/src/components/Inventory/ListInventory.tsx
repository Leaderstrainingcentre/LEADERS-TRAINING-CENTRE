...
const ListInventory = ({ inventory, loading, onDelete, currentPage, numPages, onPageChange }: Props) => {
                    ...
                    <CardBox hasTable isList className={'rounded shadow-none'}>
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>AvailableQuantity</p>
                                <p className={'line-clamp-2'}>{ item.available_quantity }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>ReservedQuantity</p>
                                <p className={'line-clamp-2'}>{ item.reserved_quantity }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>ReturnedQuantity</p>
