...
module.exports = class Raw_materialsDBApi {
    ...
    static async bulkImport(data, options) {
        ...
        // Bulk create items
        const raw_materials = await db.raw_materials.bulkCreate(raw_materialsData, { transaction });
    ...
    static async update(id, data, options) {
        ...
        const raw_materials = await db.raw_materials.findByPk(id, {}, {transaction});
        ...
        if (data.reorder_level !== undefined) updatePayload.reorder_level = data.reorder_level;
    ...
    static async findAll(filter, options) {
        ...
        try {
            const { rows, count } = await db.raw_materials.findAndCountAll(queryOptions);
