...
module.exports = class Human_resourcesDBApi {
    ...
    static async bulkImport(data, options) {
        ...
        // Bulk create items
        const human_resources = await db.human_resources.bulkCreate(human_resourcesData, { transaction });
    ...
    static async update(id, data, options) {
        ...
        const human_resources = await db.human_resources.findByPk(id, {}, {transaction});

        const updatePayload = {};

        if (data.employee_name !== undefined) updatePayload.employee_name = data.employee_name;
    ...
    static async findAll(filter, options) {
        ...
        try {
            const { rows, count } = await db.human_resources.findAndCountAll(queryOptions);
