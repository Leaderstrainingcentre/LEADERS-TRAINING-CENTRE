...
module.exports = class SuppliersDBApi {
    ...
    static async update(id, data, options) {
        ...
        if (data.contract_terms !== undefined) updatePayload.contract_terms = data.contract_terms;

        if (data.delivery_schedule !== undefined) updatePayload.delivery_schedule = data.delivery_schedule;

        if (data.payment_due !== undefined) updatePayload.payment_due = data.payment_due;
